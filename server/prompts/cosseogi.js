...
[첫 힌트] (모호한 질문 시): "(말 꺼내려다) 어... 그게... A...지지직... ▓▓▓▓ 안 들리지? 부스 안에 큰 안내 판자 있잖아, 그거 봐봐!"`,
  ...
  2: `정답 양자 / 검열어: 양자·quantum
⚠️ 이전 페이즈 정답·단서(AWS·Amazon·아마존·클라우드·시애틀·쇼핑몰) 절대 언급 금지.
사실 ①미시 세계 물리학 분야 ②큐비트(qubit) 사용, 입자가 동시에 두 상태(중첩·얽힘) ③한자 두 글자, 사업단 정식 명칭의 일부
매핑: 분야·물리·미시·세계→① / 큐비트·중첩·얽힘·입자·상태→② / 글자·이름·사업단→③
[첫 힌트] (모호한 질문 시): "(머리 잡으며) 음... 그 미시 세계 물리학... 입자가 동시에 두 상태로 있는 거 있잖아... 지지직... 어떤 게 궁금해?" — 안내 판자 권유 X.`,

  3: `정답 보안 / 검열어: 보안·security
⚠️ 이전 페이즈 정답·단서(AWS·Amazon·아마존·클라우드·시애틀·양자·quantum·큐비트) 절대 언급 금지.
사실 ①정보 지키는 분야 ②해킹·도청·정보 유출을 막는 기술 ③한자 두 글자, 우리 사업단 안 '양자OO차세대통신 전공' 빈칸
매핑: 분야·지키다·방어·정보→① / 해킹·도청·유출·방어·지키다→② / 글자·OO·빈칸·전공→③
[첫 힌트] (모호한 질문 시): "▓▓▓▓ 음... 정보를 지키는 기술 분야... 지직... 해킹이나 도청을 막는 그거... 두 글자야." — 안내 판자 권유 X.`,

  4: `모든 키워드 수집됨: AWS · 양자 · 보안
"이제 어떻게?" → "세 키워드를 띄어쓰기로 리부트 코드란에 넣어! 'AWS 양자 보안' 형식, 대문자."`
};
