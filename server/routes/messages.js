...
router.post('/:id/answer', (req, res) => {
  try {
    ...
    if (result.isCorrect) {
      ...
      // 🏷️ v1 (AWS / 5G / 통신) 안내 — v2 (양자/보안)와 다름
      const phaseGuide = {
        2: '(눈을 반짝이며) 노이즈가 좀 줄었어! 이제 두 번째 문제야 — **우리넷 동글이 쓰는 통신망 기술 이름**을 맞춰야 해. LTE 다음 세대인 그 빠른 거... 알지?',
        3: '(고개 끄덕이며) 좀 살 것 같아! 마지막 문제야 — **\'국민대학교 차세대OO 사업단\'** 빈칸 두 글자를 맞춰야 해. 신호 주고받는 그 분야 말이야.',
